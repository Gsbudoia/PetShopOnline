...
SECRET_KEY = 'django-insecure-_x-$0t=s73yqylobesebrtdbpo_^c@v^^z=f1y8**4foh1b3tc'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DB_PASSWORD', 'petpassword'),
        'HOST': os.getenv('DB_HOST', 'db'), # 'db' é o padrão local
